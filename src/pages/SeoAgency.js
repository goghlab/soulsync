                        ...
                        <div className="row row--30 align-items-center">
                            <div className="order-2 order-lg-1 col-lg-6 mt_md--50 mt_sm--50 mt_lg--30">
                                <div className="inner text-start">
                                    <h1 className="title color-white">Always, <br />By Your Side</h1>
                                    <p className="description color-white">Connect beyond boundaries. SoulSync: Keeping memories alive through digital companionship.</p>
                                    <div className="button-group mt--30 mt_sm--20">
                                        <a className="btn-default btn-medium btn-icon btn-border" target="_blank" href="https://themeforest.net/checkout/from_item/33571911?license=regular">Get Quote <i className="icon"><FiArrowRight /></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                    <SectionTitle
                                        ...
                                        radiusRounded = ""
                                        subtitle = "SoulSync Process"
                                        title = "Crafting timeless connections"
                                    />
                            </div>
                        </div>
                        <div className="row">
